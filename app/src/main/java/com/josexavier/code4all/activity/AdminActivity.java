...
public class AdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_inicio_mod,
                R.id.nav_contas,
                R.id.nav_posts_verificacao,
                R.id.nav_empresas,
                R.id.nav_forum,
                R.id.nav_criar_quiz, R.id.nav_listar_quiz,
                R.id.nav_criar_post, R.id.nav_listar_post,
                R.id.nav_criar_tt, R.id.nav_listar_tt,
                R.id.nav_criar_notificacao, R.id.nav_listar_notificacoes,
                R.id.nav_conta,
                R.id.nav_definicoes)
